/* 1. Write a `for ` loop that loops through the teas `["green tea","black tea","chai","oolong tea"]`.
    Store all the teas before `"chai"` in a new teas named `selectedTeas`.
 */
...
/* 2. Write a `for ` loop that loops through the array `["London","New York","Paris","Berlin"]` and skips `"Paris"`.
    Store the other cities in a new teas named `visitedCities`.
 */
...
/*5. Use a `for-in` loop to loop through an object containing city populations.
 ...
 Let `citiesPopulation`  London, New York, Paris, Berlin.
 */
...
/*7. Write a `forEach` loop that iterates through the array `["earl grey","green tea","oolong tea"]`.
