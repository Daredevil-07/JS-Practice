/* 1. Write a `while ` loop that calculates the sum of all numbers from 1 to 5 and stores the result in a varaible named `sum`
 */
...
/* 2. Write a `while ` loop that counts  from 5 to 1 and stores the numbers in a array named `countdown`.
 */
